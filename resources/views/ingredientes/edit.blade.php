...
<div class="page-header header-filter" data-parallax="true" style="background-image: url('{{ asset('img/bg_4.jpg') }}')">
  ...
  <div class="main main-raised">
    <div class="container">
      <div class="section">
        <h2 class="title text-center">Editar ingrediente</h2>
        <h4 class="text-center description">Estás tratando de editar datos del ingrediente <strong>{{ $ingrediente->nombre }}</strong> </h4>
      ...
      {!!Form::model($ingrediente,['method'=>'PUT','route'=>['ingredientes.update',$ingrediente->idingrediente]])!!}
			{{Form::token()}}
            <div class="row">
              <div class="col-sm">
              ...
              <div class="col-sm">
                  <div class="form-group">
                    <label for="exampleInput1" class="bmd-label-floating">Nombre</label>
                      <input name="nombre" type="text" class="form-control" id="exampleInput1" autocomplete="off" value="{{ $ingrediente->nombre }}">
                          <span class="bmd-help">Escriba el nombre de la ingrediente</span>
                  </div>
                </div>
            </div>
            <div class="row">
