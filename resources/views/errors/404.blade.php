	...
	<div class="container" style="background-color: #eee; border-radius: 20px; margin-top: 100px; ">
		<div class="row">
			<div class="col-sm" style="">
				 <img style="width: 300px; height: 300px; margin-top: 10px; margin-bottom: 15px;" src="{{asset('img/error404.png')}}" class="img-raised img-thumbnail img-fluid">
				 <label style="font-size: 4em;">Error 404</label>
			</div>
			<div class="col-4">
				<h3>
					<strong style="color: red;">
						La página no se encontró y/o no está implementada, te recomendamos regresar al inicio. 
					</strong>
					<p style="color: black;">
